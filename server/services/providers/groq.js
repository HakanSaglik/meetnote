...
export class GroqProvider extends BaseAIProvider {
  constructor() {
    super('groq', 'Groq Llama', 'Groq\'s ultra-fast Llama 3 models with high rate limits');
    this.apiKey = process.env.GROQ_API_KEY;
    this.apiUrl = 'https://api.groq.com/openai/v1/chat/completions';
    this.model = 'llama-3.1-70b-versatile'; // High performance model
  }
  ...
  async extractImportantTasks(meetings) {
    try {
      ...
      console.log('🚀 Groq extractImportantTasks called with meetings:', meetings.length);
      ...
      console.log('📝 Prompt sent to Groq:', prompt.substring(0, 500) + '...');
      ...
      console.log('🤖 Raw Groq response:', tasksText);
      ...
      console.error('Groq important tasks error:', error);
