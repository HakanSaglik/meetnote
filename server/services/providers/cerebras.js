...
export class CerebrasProvider extends BaseAIProvider {
  constructor() {
    super('cerebras', 'Cerebras Llama', 'Cerebras ultra-fast inference with 1M tokens/day free tier');
    this.apiKey = process.env.CEREBRAS_API_KEY;
    this.apiUrl = 'https://api.cerebras.ai/v1/chat/completions';
    this.model = 'llama3.1-70b'; // High performance model
  }
  ...
  async extractImportantTasks(meetings) {
    try {
      ...
      console.log('⚡ Cerebras extractImportantTasks called with meetings:', meetings.length);
      ...
      console.log('📝 Prompt sent to Cerebras:', prompt.substring(0, 500) + '...');
      ...
      console.log('🤖 Raw Cerebras response:', tasksText);
      ...
      console.error('Cerebras important tasks error:', error);
