...
export class OpenRouterProvider extends BaseAIProvider {
  constructor() {
    super('openrouter', 'OpenRouter', 'OpenRouter with access to multiple AI models including Llama, Claude, and GPT');
    this.apiKey = process.env.OPENROUTER_API_KEY;
    this.apiUrl = 'https://openrouter.ai/api/v1/chat/completions';
    this.model = 'meta-llama/llama-3.1-70b-instruct:free'; // Free Llama model
    this.siteName = process.env.OPENROUTER_SITE_NAME || 'MeetNote App';
  ...
  async extractImportantTasks(meetings) {
    try {
      ...
      console.log('🔀 OpenRouter extractImportantTasks called with meetings:', meetings.length);
      ...
      console.log('📝 Prompt sent to OpenRouter:', prompt.substring(0, 500) + '...');
      ...
      console.log('🤖 Raw OpenRouter response:', tasksText);
      ...
      console.error('OpenRouter important tasks error:', error);
